...
const laptopData = {
  Dell: [
    ...
    },
    {
      ...
      images: ["/laptops/Dell/i7/1.png", "/laptops/Dell/i7/2.png", "/laptops/Dell/i7/3.png"],
      // outOfStock: true,
    },
  ],
  Lenovo: [
    {
      ...
      images: ["/laptops/Lenovo/i3/1.png", "/laptops/Lenovo/i3/2.png", "/laptops/Lenovo/i3/3.png"],
      outOfStock: true,
    },
    {
      processor: "i5",
      ...
      images: ["/laptops/Lenovo/i5/1.png", "/laptops/Lenovo/i5/2.png", "/laptops/Lenovo/i5/3.png"],
      // outOfStock: true,
    },
    {
      processor: "i7",
  ...
  HP: [
    {
      ...
      images: ["/laptops/Hp/i3/1.png", "/laptops/Hp/i3/2.png", "/laptops/Hp/i3/3.png"],
      // outOfStock: true,
    },
    {
      processor: "i5",
      ...
      images: ["/laptops/Hp/i5/1.png", "/laptops/Hp/i5/2.png", "/laptops/Hp/i5/3.png"],
      // outOfStock: true,
    },
    {
      processor: "i7",
      ...
      images: ["/laptops/Hp/i7/1.png", "/laptops/Hp/i7/2.png", "/laptops/Hp/i7/3.png"],
      outOfStock: true,
    },
  ],
}
